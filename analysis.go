...
// Severity classifies the importance of an analysis finding.
...
// Finding represents a single heuristic result from config analysis.
type Finding struct {
	// RuleID identifies the heuristic (e.g. "RISK001").
	RuleID string `json:"rule_id"`
	// Severity is the finding's severity level (warning or info).
