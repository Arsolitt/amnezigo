...
// WriteServerConfig writes a server WireGuard configuration to the given writer.
...
func WriteClientConfig(w io.Writer, cfg ClientConfig) error {
	...
	// Write H1-H4 as ranges (same as server)
	fmt.Fprintf(w, "H1 = %d-%d\n", cfg.Interface.Obfuscation.H1.Min, cfg.Interface.Obfuscation.H1.Max)
